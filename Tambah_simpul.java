...
public class Tambah_simpul{
	...
	public String[][] modif_graph = new String[100][100];
	...
	public void createAndSave_NewJsonCoordinate(int mulai, int limit, JSONArray jArrCoordinates,
													 int new_id, int field_simpul_awal, int field_simpul_tujuan, double new_bobot,
		...
		String gabung_nodes = String.valueOf(field_simpul_awal) + '-' + String.valueOf(field_simpul_tujuan);
		...
		newCon.put("simpul_tujuan", field_simpul_tujuan);
